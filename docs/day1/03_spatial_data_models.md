...
graph TD
    ...
    Point --> Point_D["Coordinate: (X,Y)<br/>Dimensions: 0D<br/>Examples: Rain gauges, wells, confluences"]
    Line --> Line_D["Coordinates: Series of connected points<br/>Dimensions: 1D<br/>Examples: Rivers, pipelines, roads"]
    Polygon --> Polygon_D["Coordinates: Closed loop of lines<br/>Dimensions: 2D<br/>Examples: Catchments, reservoirs, soil zones"]
...
## 4. Choosing the Right Data Model
...
```mermaid
graph TD
    Q[What is your primary analytical goal?] --> Overlay[Perform cell-by-cell math or model gradients?]
    Q --> Network[Model network flow, routing, or precise boundaries?]
    
    Overlay --> RasterAns[Choose RASTER<br/><i>DEMs, Rainfall grids, NDVI</i>]
    Network --> VectorAns[Choose VECTOR<br/><i>River lines, Catchment boundaries, Gauges</i>]
